...
<header class:scrolled>
  <div class="container">
    <a href="#home" class="logo" on:click={closeMobileMenu}>
      <img src="/logo.png" alt="Golden House Logo" class="logo-img" />
    </a>
    ...
    <a href="https://wa.me/51913685917?text=Hola%2C%20quisiera%20solicitar%20una%20cotización" target="_blank" rel="noopener noreferrer" class="btn-cotizar desktop-only">Cotizar</a>
